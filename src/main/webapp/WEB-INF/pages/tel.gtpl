   ...
   <table border="0">
      <tbody>
         ...
         <td>
          ...
          <select data-placeholder="Selecione os Grupos..." class="chosen-select" style="width: 350px; display: none;" tabindex="-1">
            <option value=""></option>
          ...
          <div class="chosen-container chosen-container-single chosen-container-active" style="width: 350px;" title="">
            <a class="chosen-single chosen-default" tabindex="-1"><span>Selecione um ou mais Grupos</span><div><b></b></div></a>
            <div class="chosen-drop">
              <div class="chosen-search">
                <input type="text" autocomplete="off" tabindex="2">
              </div>
              <ul class="chosen-results">
                <% request.groups.eachWithIndex { group, i -> %>
                  <li class="active-result" style="" data-option-array-index="$i">${group.name}</li>
                <% } %>          
              </ul>                
            </div>
          </div>
